...
export const products: Product[] = [
    ...
    pots: [
      {
        id: 1,
        name: 'P9',
        variants: [{ id: 1, value: '25-40', postfix: 'см', price: 5, inStock: true }],
      },
      {
        id: 2,
        name: 'C2',
    ...
    pots: [
      {
        id: 1,
        name: 'P9',
        variants: [{ id: 1, value: '35-50', postfix: 'см', price: 5, inStock: true }],
      },
      {
        id: 2,
        name: 'C2',
  ...
  },
  {
    ...
    image: thujaImage,
    pots: [
      { id: 1, name: 'P9', variants: [{ id: 1, price: 6, inStock: true }] },
      { id: 2, name: 'C2', variants: [{ id: 1, price: 12, inStock: true }] },
      { id: 3, name: 'C3', variants: [{ id: 1, price: 15, inStock: true }] },
      { id: 4, name: 'C5', variants: [{ id: 1, price: 35, inStock: true }] },
    ],
  },
  {
    id: 'thuja-hoseri',
    ...
    pots: [
      { id: 1, name: 'P9', variants: [{ id: 1, price: 6, inStock: true }] },
      { id: 2, name: 'C5', variants: [{ id: 1, price: 35, inStock: true }] },
    ],
  },
  {
    id: 'thuja-rheingold',
